...
public class ReplicarEstoqueIn1 extends Activity implements Runnable{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.replicarestoqueoin1);
		...
		c = db.rawQuery("insert into estoq (prod) values (" + "" + ");", null);
		totalDB = c.getCount();
		...
		btnIniciar.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
					Builder msg = new Builder(ReplicarEstoqueIn1.this);
					msg.setMessage("Deseja iniciar a replicação?");
					msg.setPositiveButton("SIM", new DialogInterface.OnClickListener() {
						
						@Override
						public void onClick(DialogInterface arg0, int arg1) {
							pg = ProgressDialog.show(ReplicarEstoqueIn1.this, "Aguarde...", "Replicando dados", true, false, null);
							Thread t = new Thread(ReplicarEstoqueIn1.this);
							t.start();
						}
					});
	...
	public void run() {
		while(c.moveToNext()){
			...
			strURL.append("http://192.168.1.3:8080/AndroidWeb/ListarEstoque.jsp");
